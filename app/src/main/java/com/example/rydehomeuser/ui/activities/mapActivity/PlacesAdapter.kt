...
class PlacesAdapter(context: Context, resourceId: Int, geoData: GeoDataClient, filter: AutocompleteFilter?, boundS_GREATER_SYDNEY: LatLngBounds) : ArrayAdapter<AutocompletePrediction>(context, resourceId),
    Filterable {
    ...
    private fun getAutocomplete(constraint: CharSequence): ArrayList<AutocompletePrediction>? {
        ...
        try {
            Log.e("Rcrcrdx",results.toString())
            ...
            Toast.makeText(mContext, "Something went wrong.Please try again later.",
