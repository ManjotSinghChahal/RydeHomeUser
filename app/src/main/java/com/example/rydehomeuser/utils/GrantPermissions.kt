...
import com.example.rydehomedriver.ui.activities.splashScreen.SplashView

class GrantPermissions(val activity: Activity, val list: List<String>, val code:Int,val loginview : SplashView) {
